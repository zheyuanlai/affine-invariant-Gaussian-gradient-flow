...
# ---------------------------------------------------------------------------
# Import the shared display-only helpers from scripts/plotting_utils.py
# (leaf plotting module -> scripts helper; the import direction is fine because
#  plotting_utils has no project dependencies of its own).
# ---------------------------------------------------------------------------

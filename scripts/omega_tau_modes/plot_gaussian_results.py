...
Defaults:
    --indir  outputs/omega_tau_modes/gaussian_grid
    --figdir outputs/omega_tau_modes/gaussian_grid/figures
...
from src.omega_tau_modes.plotting import generate_all_figures

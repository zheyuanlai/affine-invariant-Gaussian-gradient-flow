...
If --path is not given, defaults to outputs/omega_tau_modes/logconcave_grid/reference_optimum.npz.
"""
import argparse
import os
import sys
...
from src.omega_tau_modes.reference_optimum import load_reference_optimum
from src.omega_tau_modes.targets import LogCoshTarget
from src.omega_tau_modes.qmc_samples import make_samples


def parse_args():
    p = argparse.ArgumentParser()
    p.add_argument("--path", default="outputs/omega_tau_modes/logconcave_grid/reference_optimum.npz")

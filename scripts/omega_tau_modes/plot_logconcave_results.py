...
Options:
    --results   path to results_long.csv  (default: outputs/omega_tau_modes/logconcave_grid/results_long.csv)
    --summary   path to summary.csv       (default: outputs/omega_tau_modes/logconcave_grid/summary.csv)
...
from src.omega_tau_modes.lc_plotting import generate_lc_figures


def parse_args():
    p = argparse.ArgumentParser(description="Plot log-concave gradient flow results.")
    p.add_argument("--results", default="outputs/omega_tau_modes/logconcave_grid/results_long.csv")
    p.add_argument("--summary", default="outputs/omega_tau_modes/logconcave_grid/summary.csv")

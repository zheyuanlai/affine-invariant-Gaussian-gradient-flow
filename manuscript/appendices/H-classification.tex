...
\begin{proof}[Representation-theoretic proof of \Cref{thm:aff-class}]
    ...
    The mean--covariance cross term vanishes. Indeed, put $L(u, X) := b((u,0),(0,X))$. Invariance under the sign element $Q = -I$ of \eqref{eq:app-cl-isotropy} gives $L(u, X) = L(-u, X) = -L(u, X)$, hence $L \equiv 0$; this is the representation-theoretic form of the sign-element argument used in the proof of \Cref{thm:aff-class}.

...
Price/Hessian estimators, at the cost of explicit variance floors that scale as
$1/B$ in the batch size and vanish for Gaussian targets. The stochastic local result is a killed-process contraction together with a

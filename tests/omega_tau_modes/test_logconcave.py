...
from src.omega_tau_modes.reference_optimum import _pack, _unpack, _objective_and_grad
from src.omega_tau_modes.qmc_samples import make_samples, push_forward
from src.omega_tau_modes.utils import spd_invsqrt, make_q_vector
...
def test_objective_gap_near_zero_at_star(target5, Z5):
    ...
    from src.omega_tau_modes.reference_optimum import compute_reference_optimum
